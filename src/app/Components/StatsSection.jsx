...
export default function StatsSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-black via-[#AA2428] to-black text-white">
      <div className="max-w-7xl mx-auto px-4 text-center mb-12">
        ...
        <p className="text-white/90 max-w-2xl mx-auto text-base md:text-lg">
          ...
          <strong> D4 Interactive </strong> consistently delivers top-tier
          digital solutions backed by measurable success.
        </p>
      </div>
